...
<head>
<meta charset="utf-8">
<title>模块列表-思途CMS{$coreVersion}</title>
        ...
        <tr>
            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                <div class="cfg-header-bar">
                    <span class="cfg-select-box btnbox mt-5 ml-10" id="version" data-url="box/index/type/moduleversion" data-result="result_version">版本切换&nbsp;&gt;&nbsp;<span id="result_version">全部</span><i class="arrow-icon"></i></span>
...
<script>
  ...
  Ext.onReady(
    function() 
    {
        ...
        window.product_store=Ext.create('Ext.data.Store',{
		 ...
		 fields:['id','aid','webid','modulename','issystem','version'],
  ...
  function del(id,issystem)
  {
    ...
    function addModule()
    {
        ...
        ST.Util.showBox('添加模块',boxurl,600,327,function(){ window.product_store.load(); });
    }
   //修改
   function modify(id)
   {
       var boxurl = SITEURL+'module/edit/id/'+id;
       ST.Util.showBox('模块修改',boxurl,600,327,function(){ window.product_store.load(); });
   }
