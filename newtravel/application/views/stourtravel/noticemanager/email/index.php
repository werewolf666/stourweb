...
<!--面包屑-->
    ...
    <div class="manage-nr">
        ...
        <div class="sms-set">
            <div class="msg-bar" id="msg-bar">
                {php}$condition=isset($_GET['typeid'])?$_GET['typeid']:$_GET['type'];{/php}
                <span class="type_tongyong" id="tongyong" data-if="tongyong">扩展产品通知</span>
            </div>
            <div class="msg-switcher">
            {template 'stourtravel/noticemanager/email/tongyong_notice'}
            </div>
