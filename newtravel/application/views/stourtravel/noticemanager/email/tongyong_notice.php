    ...
    <form id="tongyongfrm">
        <div class="set-one">
            <div class="set-one-box">
                ...
                <div class="box-con">
                    <textarea name="msg1">{$order_msg1}</textarea>
                </div>
            </div>
        ...
        <div class="set-one">
            <div class="set-one-box">
                ...
                <div class="box-con">
                    <textarea name="msg2">{$order_msg2}</textarea>
                </div>
            </div>
            <div class="set-one-tool">
                <div class="tool-cs">
        ...
        <div class="set-one">
            <div class="set-one-box">
                ...
                <div class="box-con">
                    <textarea name="msg3">{$order_msg3}</textarea>
                </div>
            </div>
            <div class="set-one-tool">
        ...
        <div class="set-one">
            <div class="set-one-box">
                ...
                <div class="box-con">
                    <textarea name="msg4">{$order_msg4}</textarea>
                </div>
            </div>
            <div class="set-one-tool">
        ...
        <div class="set-save">
            <a class="normal-btn" href="javascript:;" id="tongyong_btn_saveg">保存</a>
            <input type="hidden" name="msgtype" value="tongyong_order_msg"/>
...
<script language="javascript">
    $(function(){
        $("#tongyong_btn_saveg").click(function(){
            $.ajax({
                url:SITEURL+'noticemanager/ajax_save_email_msg',
                data: $('#tongyongfrm').serialize(),
                type: "POST",
                dataType:'json',
