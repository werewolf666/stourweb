    ...
    <form id="supplier_configfrm">
        <div class="set-one">
            ...
            <div class="set-one-tool">
                <div class="tool-cs">
                    <span><input type="radio" name="cfg_supplier_email_open" value="1" {if $config['cfg_supplier_email_open']==1}checked="checked"{/if}/><label>开启</label></span>
                    <span><input type="radio" name="cfg_supplier_email_open" value="0" {if  $config['cfg_supplier_email_open']==0}checked="checked"{/if}/><label>关闭</label></span>
                </div>
            </div>
        </div>
        <div class="set-one">
            ...
            <div class="set-one-tool">
                <div class="tool-cs">
                    <span><input type="radio" name="cfg_supplier_sendemail_open" value="1" {if $config['cfg_supplier_sendemail_open']==1}checked="checked"{/if}/><label>开启</label></span>
                    <span><input type="radio" name="cfg_supplier_sendemail_open" value="0" {if $config['cfg_supplier_sendemail_open']==0}checked="checked"{/if}/><label>关闭</label></span>
                </div>
        ...
        <div class="set-one">
            <div class="set-one-box">
                <div class="box-tit">本站管理员邮箱</div>
                <div class="box-con">
                    <input name="cfg_webmaster_email" value="{$config['cfg_webmaster_email']}"/>
                </div>
            </div>
        ...
        <div class="set-one">
            <div class="set-one-box">
                ...
                <div class="box-con">
                    <textarea name="cfg_supplier_emailmsg">{$config['cfg_supplier_emailmsg']}</textarea>
                </div>
            </div>
            <div class="set-one-tool">
                <div class="tool-cs">
