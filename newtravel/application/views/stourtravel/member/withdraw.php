...
<head>
    <meta charset="utf-8">
    <title>提现-思途CMS{$coreVersion}</title>
                        ...
                        <tr>
                            <td class="head-td-lt">
                                <div class="pro-search ml-10" style=" float:left; margin-top:2px">
                                    <input type="text" id="searchkey" value="电话/联系人/订单号" datadef="电话/联系人" class="sty-txt1 set-text-xh wid_200">
    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'member/withdraw/action/read/',  //读取数据的URL
                    update: SITEURL+'member/withdraw/action/save/',
                    destroy: SITEURL+'member/withdraw/action/delete/'
                },
                reader: {
                    type: 'json',   //获取数据的格式
                    root: 'lists',
        ...
        window.product_grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                },
                {
                    ...
                    menuDisabled:true,
                    renderer: function (value, metadata, record) {
                       var way_names = {'bank':'银行卡','alipay':'支付宝','weixin':'微信'};
                        return way_names[value];
                    }
                ...
                },
                {
                    ...
                    menuDisabled:true,
                    renderer: function (value, metadata, record) {
                        var status_name = record.get('status_name');
                        return status_name;
                    }
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html = "<a href='javascript:void(0);' class='row-mod-btn' onclick=\"edit(" + id + ")\"></a>";
                        return html;
...
function updateField(ele, id, field, value, type) {
    ...
    Ext.Ajax.request({
        url: SITEURL+"member/withdraw/action/update/",
        method: "POST",
        datatype: "JSON",
...
{
    var record = window.product_store.getById(id.toString());
    var url=SITEURL+"member/withdraw_edit/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}id/"+id;
    ST.Util.addTab('提现：'+record.get('account'),url,1);
}
