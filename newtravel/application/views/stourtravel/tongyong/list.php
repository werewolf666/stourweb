       ...
       <table class="list-head-tb">
        ...
        <div class="search-bar filter" id="search_bar">
            ...
            <div class="pro-search ml-10" style=" float:left; margin-top:4px">
                <input type="text" id="searchkey" value="{$modulename}名称/{$modulename}编号" datadef="{$modulename}名称/{$modulename}编号" class="sty-txt1 set-text-xh wid_200">
	   ...
	   columns:[
           ...
           },
           {
               ...
               renderer : function(value, metadata,record) {
                   ...
                   return '<a href="javascript:;" class="row-add-suit-btn" onclick="ST.Util.addTab(\'添加{$modulename}套餐\',\'tongyong/suit/menuid/{$_GET['menuid']}/parentkey/product/typeid/{$typeid}/itemid/{$typeid}/action/add/productid/'+id+'\')">添加套餐</a>';
               },
               listeners:{
                   afterrender:function(obj,eopts)
                   {
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201701.2302&DomainName=&ServerIP=unknown&SerialNumber=50551355" ></script>
