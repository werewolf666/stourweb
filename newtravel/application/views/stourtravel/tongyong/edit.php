                  ...
                  <div class="product-add-div">
                      ...
                      <div class="add-class">
                          <dl>
                              <dt>目的地选择：</dt>
                              <dd>
                                  <a href="javascript:;" class="choose-btn mt-4"  onclick="Product.getDest(this,'.dest-sel','{$typeid}')"  title="选择">选择</a>
                          ...
                          <dl>
                              ...
                              <dl>
                                  <dt style="width:110px">预订送积分策略：</dt>
                                  <dd>
                                      <a href="javascript:;" class="choose-btn mt-4" onclick="Product.getJifenbook(this,'.jifenbook-sel',parseInt('{$typeid}'))" title="选择">选择</a>
                                    ...
                                    <span><s onclick="$(this).parent('span').remove()"></s>{$info['jifenbook_info']['title']}({$info['jifenbook_info']['value']}{if $info['jifenbook_info']['rewardway']==1}%{/if}积分)
                                      ...
                                      <span class="ml-10" style="color:#999">*未选择的情况下默认使用全局策略</span>
                                  </dd>
                              </dl>
                              <dl>
                                  <dt style="width:110px">积分抵现策略：</dt>
                                  <dd>
                                      <a href="javascript:;" class="choose-btn mt-4" onclick="Product.getJifentprice(this,'.jifentprice-sel',parseInt('{$typeid}'))" title="选择">选择</a>
                  ...
                  <div class="up-pic">
                      <dl>
                          ...
                          <dd>
                              ...
                              <span class="tip-img-size">建议上传尺寸1024*695px</span>
                          </dd>
                      </dl>
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.1.201711.2203&DomainName=&ServerIP=unknown&SerialNumber=50551355" ></script>
