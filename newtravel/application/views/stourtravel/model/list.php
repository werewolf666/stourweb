...
<head>
<meta charset="utf-8">
<title size_font=zCtNvk >模型列表-思途CMS{$coreVersion}</title>
...
<script>
	   ...
	   columns:[
           {
			   ...
			   {
				  // text:'模块名称',
                   text: '<span class="grid_column_text">模块名称</span>'+ST.Util.getGridHelp('model_field_modulename'),
				   width:'15%',
                   ...
                   renderer:function(value,metadata,record){
                       ...
                       return "<a href='javascript:;' class='line-title'>"+modulename+"</a>&nbsp;&nbsp;<font color=\"orange\">[id:"+id+"]</font>";
                   }
               ...
               {
                  // text:'拼音标识',
                   text: '<span class="grid_column_text">拼音标识</span>'+ST.Util.getGridHelp('model_field_pinyin'),
                   width:'15%',
                   dataIndex:'pinyin',
                   align:'left',
                   border:0,
               ...
               },
               {
                   ...
                   text: '<span class="grid_column_text">主表</span>'+ST.Util.getGridHelp('model_field_maintable'),
                   width:'20%',
                   dataIndex:'maintable',
                   menuDisabled:true,
                   align:'left',
               ...
               {
                   //text:'附加表',
                   text: '<span class="grid_column_text">附加表</span>'+ST.Util.getGridHelp('model_field_addtable'),
                   width:'25%',
                   dataIndex:'addtable',
                   menuDisabled:true,
                   align:'left',
               ...
               },
               {
                   ...
                   text: '<span class="grid_column_text">系统模型</span>'+ST.Util.getGridHelp('model_field_issystem'),
                   width:'10%',
                   align:'center',
                   border:0,
                   dataIndex:'issystem',
  ...
  function del(id,issystem)
  {
    ...
    function addModel()
    {
        ...
        ST.Util.showBox('添加模型',url,'400','120',null, null, null, {loadWindow:window,loadCallback:function(){
            window.product_store.load();
        }
    });
    }
