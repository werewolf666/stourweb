                                  ...
                                  <div class="price_sub">
                                      <div>
                                          <table class="price_tb">
                                              ...
                                              <tr>
                                                  <td class="tit">价格描述：</td><td><input type="text" class="set-text-xh text_700 mt-2" style="width: 300px" name="description" value="{$info['lastoffer']['description']}"></td>
                                              </tr>
                                              <tr>
                                                  <td class="tit">库存：</td><td><input type="text" maxlength="4" class="set-text-xh text_100 mt-2" name="number" value="{$info['lastoffer']['number']}"> <span style="color:gray;padding-left:10px">-1表示不限</span></td>
                                              </tr>
                                          </table>
