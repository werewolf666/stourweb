{php echo Common::getScript('jquery-1.8.3.min.js,common.js,jquery.hotkeys.js,msgbox/msgbox.js,ajaxform.js,extjs/ext-all.js,extjs/locale/ext-lang-zh_CN.js'); }
...
<script>
    ...
    window.BACK_CURRENCY_SYMBOL="{Currency_Tool::back_symbol()}";
...
</script><script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201611.0704&DomainName=&ServerIP=unknown&SerialNumber=70247748" ></script>
