...
<body style="overflow:hidden" right_border=z0MaAj >
    ...
    function () {
        ...
        window.product_store = Ext.create('Ext.data.Store', {
            ...
            proxy: {
                type: 'ajax',
                api: {
                    read: SITEURL+'question/index/action/read{if isset($_GET["typeid"])}/typeid/{$_GET["typeid"]}{/if}',  //读取数据的URL
        ...
        window.product_grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
                ...
                },
                {
                    ...
                    text: '<span class="grid_column_text">产品名称或标题</span>'+ST.Util.getGridHelp('question_field_productname'),
                    width: '20%',
                ...
                },
                {
                    ...
                    text: '<span class="grid_column_text">提问人</span>'+ST.Util.getGridHelp('question_field_nickname'),
                    width: '15%',
                    dataIndex: 'nickname',
                    align: 'left',
                    border: 0,
                ...
                },
                {
                    ...
                    text: '<span class="grid_column_text">回复情况</span>'+ST.Util.getGridHelp('question_field_replytime'),
                    width: '10%',
                    dataIndex: 'replytime',
                    align: 'left',
                    border: 0,
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        if(value==null){
                            return '<span class="c-999">未回复</span>';
                        }
                        else{
                            return '<span class="c-green">已回复</span>';
                        }
                ...
                {
                    text: '<span class="grid_column_text">类型</span>'+ST.Util.getGridHelp('question_field_questype'),
                    width: '8%',
                    dataIndex: 'questype',
                    align: 'left',
                    border: 0,
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html = "<a href='javascript:void(0);' class='btn-link' onclick=\"view(" + id + ")\">编辑</a>";
                            html+= "&nbsp;&nbsp;"
                            html+= "<a href='javascript:void(0);' class='btn-link ml-10' onclick=\"delS(" + id + ")\">删除</a>";
                        return html;
...
function view(id)
{
    ...
    ST.Util.addTab('查看问答', 'question/view/menuid/{$_GET["menuid"]}/id/'+id);
