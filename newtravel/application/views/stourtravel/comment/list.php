            ...
            columns: [
...

                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var   html = "<a href='javascript:void(0);' title='编辑'  class='btn-link' onclick=\"goModify("+id+")\">编辑</a>&nbsp;&nbsp;<a href='javascript:void(0);' title='删除' class='btn-link' onclick=\"del(" + id + ")\">删除</a>";
                        return html;
