...
{if $type=='custom_website'}
<!--站点选择弹出框-->
<div class="change-box-more" id="weblist_detail">
    <div class="level web_list">
        <a href="javascript:;" class="{if empty($jmp_webid)}cur{/if}" onclick="custom_website(this,0,'主站','{$resultid}')">主站</a>
        {loop $weblist $v}
        <a href="javascript:;"  {if $jmp_webid==$v['webid']}class="cur"{/if}  onclick="custom_website(this,{$v['webid']},'{$v['webname']}','{$resultid}')" >{$v['webname']}</a>
        {/loop}
    </div>
</div>
{/if}
...
{if $type=='moduleversion'}
<!--帮助分类弹出框-->
<div class="change-box-more" id="moduleversion_detail">

    <div class="level">

        <a href="javascript:;" class="cur" data-level="1" onclick="CHOOSE.changeModuleVersion(this,0,'全部','{$resultid}',1)">全部</a>

        <a href="javascript:;" data-level="1" onclick="CHOOSE.changeModuleVersion(this,4,'电脑版本(4.X)','{$resultid}',0)" >电脑版本(4.X)</a>
        <a href="javascript:;" data-level="1" onclick="CHOOSE.changeModuleVersion(this,5,'电脑版本(5.X)','{$resultid}',0)" >电脑版本(5.X)</a>
