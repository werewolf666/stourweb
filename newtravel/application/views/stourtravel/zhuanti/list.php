  ...
  Ext.onReady(
    function() 
    {
        ...
        $("#addbtn").click(function(){
            ST.Util.addTab('添加专题',SITEURL+'zhuanti/add/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/sale/itemid/3');
        });
	   ...
	   columns:[
			   ...
			   
			   {
				   ...
				   renderer : function(value, metadata,record) {    
						   ...
						   return "<a href='javascript:;' class='row-mod-btn' onclick=\"ST.Util.addTab('修改"+title+"','"+SITEURL+"zhuanti/edit/menuid/{$_GET['menuid']}/parentkey/sale/itemid/2/themeid/"+value+"')\"></a>";
