       ...
       <!-- <div class="add_menu-btn" style="border: none">
        ...
        <div class="filter">
			...
			<select id="version" class="bd_style wid_100">
				<option value="advertise5x/index/parentkey/sale/itemid/1">5.x版</option>
				<option value="advertise/index/parentkey/sale/itemid/1" selected="selected">4.x版</option>
			</select>
            {/if}
                   ...
                   items:[
                       {
                           ...
                           {
                               var id=record.get('id');
                               var value=record.get('ishidden');
                               value=value==1?0:1;
                               updateField(0,id,'ishidden',value,0);
                           }
                       }
                   ]
               },
...
//预览
   ...
   {
       ST.Util.messagBox('预览','<img src="'+litpic+'" style="max-width:100%">',true,600,400);
   }
</script>
