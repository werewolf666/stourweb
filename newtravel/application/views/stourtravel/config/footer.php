    ...
    <table class="content-tab">
        <tr>
            ...
            <td valign="top" class="content-rt-td">
                ...
                <form id="configfrm" head_ul=Lyvz8B >
                    <div class="w-set-con">

                        <div class="w-set-nr">
                            <ul class="info-item-block">
                                <li>
                                    <span class="item-hd">底部内容{Common::get_help_icon('cfg_footer')}：</span>
                                    <div class="item-bd">
                                        {php Common::getEditor('cfg_footer',$configinfo['cfg_footer'],$sysconfig['cfg_admin_htmleditor_width'],300);}
                                    </div>
                                </li>
                            </ul>
