...
<head>
    <meta charset="utf-8">
    <title>供应商管理-思途CMS{$coreVersion}</title>
...
<body style="overflow:hidden" bottom_top=5ZGwOs >
        ...
        <td valign="top" class="content-rt-td" style="overflow:hidden">
            <div class="cfg-header-bar">
                ...
                <div class="cfg-header-search">
                	<input type="text" id="searchkey" placeholder="会员昵称/手机号/邮箱" value=""  class="search-text" />
...
Ext.onReady(
    function () {
        ...
        $("#addbtn").click(function(){
            var url=SITEURL+"supplier/add/menuid/{$_GET['menuid']}/parentkey/member/itemid/2";
            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record, rowIndex, colIndex) {
                        var id = record.get('id');
                        if (!isNaN(id)) {
                            var html = "<select onchange=\"updateField(this," + id + ",'kindid',0,'select')\" class='row-edit-select'><option value='0'>所有</option>";
...
function modify(id)
{
    var url=SITEURL+"supplier/edit/menuid/{$_GET['menuid']}/parentkey/member/itemid/3/id/"+id;
