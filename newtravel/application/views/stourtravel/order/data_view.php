...
<head>
    ...
    {php echo Common::getCss('base.css,order.css'); }
</head>
...
<div class="pop_order_box">
    ...
    <div class="day_order_table">
        <table width="100%" border="1">
            <tr>
                <th height="38" align="center" bgcolor="#F1F8FB" scope="col"><a class="prev" href="javascipt:void(0)"></a></th>
                <th colspan="11" bgcolor="#F1F8FB" scope="col"><span class="year">{$thisyear}</span></th>
                <th align="center" bgcolor="#F1F8FB" scope="col"><a class="next next_unvalid" href="javascipt:void(0)"></a></th>
            </tr>
            <tr>
...
<script>
    ...
    $(function(){
        //订单基本统计
        $.getJSON(SITEURL+'order/ajax_sell_tj/typeid/'+typeid,function(data){
    ...
    function getYearOrder()
    {
        ...
        $.getJSON(SITEURL+'order/ajax_year_tj/typeid/'+typeid+"/year/"+year,function(data){
