...
<script>
    ...
    function getConfig(webid) {
        var fields=['cfg_huizhe_partnerid','cfg_huizhe_key','cfg_huizhe_sonpartnerid','cfg_huizhe_member_name',
            'cfg_huizhe_member_mobile,cfg_huizhe_member_email','cfg_huizhe_member_address','cfg_huizhe_member_company','cfg_insurance_buyer_name',
            'cfg_insurance_buyer_pinyin','cfg_insurance_buyer_cardtype','cfg_insurance_buyer_cardcode','cfg_insurance_buyer_sex','cfg_insurance_buyer_birthday',
            'cfg_insurance_buyer_address','cfg_insurance_buyer_postcode','cfg_insurance_buyer_phone','cfg_insurance_buyer_mobile','cfg_insurance_buyer_fax','cfg_insurance_buyer_email',
            'cfg_insurance_buyer_homeaddress','cfg_insurance_buyer_jobcode','cfg_insurance_buyer_joblevel','cfg_insurance_buyer_job'];
