...
<body style="overflow:hidden" bottom_margin=H9KwOs >
            ...
            columns: [
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        var disabled = issystem == 1 ? 'disabled="disabled"' : '';
                        if(id.indexOf('add')==-1)
                            return "<input type='checkbox' class='attr_check' "+disabled+" value='" + id + "' style='cursor:pointer'/>";
                    }
                ...
                },
                {
                    ...
                    renderer : function(value, metadata,record) {
                        ...
                        if(id.indexOf('add')!=-1 || pid=='0')
                            return '';
                        var front_view = '&nbsp;&nbsp;&nbsp;<a href="javascript:;" class="row-view-btn" title="预览" onclick="front_view(\''+id+'\')"></a>';
                        return '<a href="javascript:;" onclick="attrSet('+id+','+{$typeid}+')">配置</a>'+front_view;
                    }
                }
            ],
            plugins: [
...
function front_view(id){
    var pinyin = '{$pinyin}';
    id = Number(id)>0 ? id : 0;
    var url = BASEHOST+'/'+pinyin+'/'+'all-0-'+id+'-1';
    window.open(url);
}
