    ...
    function () {
        ...
        window.attr_treepanel = Ext.create('Ext.tree.Panel', {
            ...
            columns: [
                ...
                {
                    text: '<span class="grid_column_text">显示</span>'+"{php echo Common::getIco('help',141);}",
                    dataIndex: 'isopen',
                    width: '9%',
                    xtype: 'actioncolumn',
                    tdCls: 'attr-al-mid',
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201701.2001&DomainName=&ServerIP=unknown&SerialNumber=50551355" ></script>
