<!doctype html>
<html>
<head border_font=zOTFNk >
<meta charset="utf-8">
<title>访问记录-思途CMS{$coreVersion}</title>
	            ...
	            <div class="cfg-header-bar">
	            	<div id="agent_choose">
		            	<span class="select-box w150 mt-5 ml-10 fl">
		                   	<select name="keywordtype" id="keywordtype" class="select" onchange="goSearch(this.value,'keywordtype')">
	                ...
	                <a href="javascript:;" class="fr btn btn-primary radius mt-6 mr-10" id="genbtn">生成</a>             
	            </div>
   ...
   Ext.onReady(
    function() 
    {
        ...
        $("#genbtn").click(function(){
            ...
            ST.Util.showBox('生成链接',url,600,200,function(){});
        });
	  ...
	  window.product_grid=Ext.create('Ext.grid.Panel',{ 
	   ...
	   columns:[
...

			   {
                   ...
                   text: '<span class="grid_column_text">关键词</span>'+ST.Util.getGridHelp('tooklink_index_title'),
				   width:'25%',
				   dataIndex:'title',
				   align:'left',
				   border:0,
...

               {
                   ...
                   text: '<span class="grid_column_text">链接URL</span>'+ST.Util.getGridHelp('tooklink_index_linkurl'),
                   width:'20%',
                   dataIndex:'linkurl',
                   align:'left',
                   border:0,
           ...
           {
               text: '<span class="grid_column_text">关键词类型</span>'+ST.Util.getGridHelp('tooklink_index_type'),
               width:'10%',
               dataIndex:'type',
               align:'left',
               border:0,
