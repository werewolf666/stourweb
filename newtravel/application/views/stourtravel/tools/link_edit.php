...
<body style="background-color: #fff">
   <form id="frm" name="frm">
    <div class="out-box-con">
        <dl class="list_dl">
            <dt class="wid_90">关键词{Common::get_help_icon('tooklink_index_title',true)}：</dt>
            <dd>
        ...
        <dl class="list_dl">
            <dt class="wid_90">类型{Common::get_help_icon('tooklink_index_type',true)}：</dt>
            <dd>
        ...
        <dl class="list_dl">
            <dt class="wid_90">链接地址{Common::get_help_icon('tooklink_index_linkurl',true)}：</dt>
