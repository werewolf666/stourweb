...
<head>
<meta charset="utf-8">
<title>tag词管理-思途CMS{$coreVersion}</title>
	  ...
	  window.product_grid=Ext.create('Ext.grid.Panel',{ 
	   ...
	   columns:[
...

			   {
                   ...
                   text: '<span class="grid_column_text">标题</span>'+ST.Util.getGridHelp('tagword_index_title'),
				   width:'45%',
				   dataIndex:'title',
				   align:'left',
				   border:0,
			   ...
			   },
               {
                   ...
                   text: '<span class="grid_column_text">tag词</span>'+ST.Util.getGridHelp('tagword_index_tagword'),
                   width:'50%',
                   dataIndex:'tagword',
                   align:'left',
                   border:0,
