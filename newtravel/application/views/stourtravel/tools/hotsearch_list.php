            ...
            <td valign="top" class="content-rt-td" style="overflow:hidden">
                <div class="cfg-header-bar">
                    ...
                    <div class="cfg-header-search">
                        <input type="text" id="searchkey" value="热搜词" datadef="热搜词" class="search-text" />
        ...
        window.product_grid = Ext.create('Ext.grid.Panel', {
            ...
            columns: [
...

                {
                    ...
                    text: '<span class="grid_column_text">搜索词</span>'+ST.Util.getGridHelp('hotsearch_index_keyword'),
                    width: '69%',
                    dataIndex: 'keyword',
                    align: 'left',
                    menuDisabled:true,
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=7.0.201711.0107&DomainName=&ServerIP=unknown&SerialNumber=50551355" ></script>
