<!doctype html>
<html>
<head ul_float=zq5Udk >
<meta charset="utf-8">
<title>文章管理-思途CMS{$coreVersion}</title>
   ...
   <tr>
    ...
    <td valign="top" class="content-rt-td" style="overflow:hidden">
		...
		<div class="cfg-header-bar">
			<span class="cfg-select-box btnbox mt-5 ml-10" id="helpkind" data-url="box/index/type/helpkind" data-result="result_helpkind" >分类&nbsp;&gt;&nbsp;<span id="result_helpkind">全部</span><i class="arrow-icon"></i></span>
			<div class="cfg-header-search">
				<input type="text" id="searchkey" value="帮助名称" datadef="帮助名称" class="search-text">
...
<script>
    ...
    function() 
    {
        ...
        //添加按钮
         $("#addbtn").click(function(){
            ...
            ST.Util.addTab('添加帮助','{$cmsurl}help/add/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/article/itemid/7',1);
        });
	   ...
	   bbar: Ext.create('Ext.toolbar.Toolbar', {
				  ...
				  listeners: {
						...
						//	bar.down('tbfill').hide();
							...
							bar.insert(0,Ext.create('Ext.panel.Panel',{border:0,html:'<div class="panel_bar"><a class="btn btn-primary radius mr-10" href="javascript:void(0);" onclick="CHOOSE.chooseAll()">全选</a><a class="btn btn-primary radius mr-10" href="javascript:void(0);" onclick="CHOOSE.chooseDiff()">反选</a><a class="btn btn-primary radius mr-10" href="javascript:void(0);" onclick="CHOOSE.delMore()">删除</a></div>'}));
  ...
  function goModify(id)
  {
	  ...
	  ST.Util.addTab("修改帮助",'help/edit/{if isset($_GET['menuid'])}menuid/{$_GET['menuid']}/{/if}parentkey/article/itemid/6/helpid/'+id);
  }
