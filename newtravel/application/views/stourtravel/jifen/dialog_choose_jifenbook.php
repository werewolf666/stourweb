...
<div class="s-main">
    ...
    <div class="s-list" style="height:355px">
        <table id="dlg_tb" class="dlg-list" body_size=zOTFNk >
            <tr class="dlg-hd"><th width="20%">调用标识</th><th width="50%">策略标题</th><th width="15%">赠送分数</th><th class="hd-last">选择</th></tr>
        </table>
...
<script>
   ...
   function load(page)
   {
       ...
       var url=SITEURL+'jifen/ajax_choose_jifenbook';
       $.ajax({
           type: "post",
           url: url,
           dataType: 'json',
