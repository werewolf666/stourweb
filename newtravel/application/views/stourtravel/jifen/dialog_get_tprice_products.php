...
<head>
    ...
    {php echo Common::getCss('dialog_basic.css'); }
</head>
<body >
<div class="s-main">
    <div class="s-search">
...
<script>
    ...
    $(function(){
        ...
        $(".confirm-btn").click(function(){
            ...
            var url=SITEURL+'jifen/ajax_set_tprice';
            $.ajax({
                type: "post",
                url: url,
                dataType: 'json',
   ...
   function load(page)
   {
       ...
       var url=SITEURL+'jifen/ajax_get_tprice_products';
       $.ajax({
           type: "post",
           url: url,
           dataType: 'json',
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201704.2007&DomainName=&ServerIP=unknown&SerialNumber=50551355" ></script>
