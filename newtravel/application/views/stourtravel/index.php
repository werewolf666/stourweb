...
<div class="header" id="header">
    <div class="top-page" >
        <div class="logo"><img class="fl" src="{$GLOBALS['cfg_public_url']}images/logo.png"/></div>
        <div class="top-operate">
            <ul class="fl">

                <li class="web-home"><a href="../" target="_blank">网站首页</a></li>
                <li class="clear-style"><a href="javascript:;" id="clearbtn">清除缓存</a></li>
                <li class="create-txt"><a href="javascript:;" id="howtouse">新手教程</a></li>
...
<div class="remind-msg-tip" style="display: none">您可以通过这里再次进入教程</div>
...
Ext.onReady(function () {
    ...
    window.gbl_tabs = Ext.create('Ext.tab.Panel', {
        ...
        items: [
            {
                title: '系统主页',
                html: "<iframe src='{$cmsurl}index/index5' id='change_iframe' width='100%' height='100%' frameborder='0px' ></iframe>",
                fixed:true,
                listeners: {
