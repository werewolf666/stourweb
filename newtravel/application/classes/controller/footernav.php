...
class Controller_Footernav extends Stourweb_Controller{
    ...
    * */
    ...
    public function action_index()
    {
        ...
        $this->display('stourtravel/footernav/list');
   ...
   * */
    public function action_addnav()
    {
        ...
        $this->display('stourtravel/footernav/edit');
    }
    /*
     * 底部导航修改
     * */
    ...
    public function action_ajax_getfooternav()
    {
      ...
      /*  $out = array();
        foreach($arr as $row)
        {
            ...
            $mobileshow = $row['mobileshow'] ? Common::getIco('show') : Common::getIco('hide');
            $tr ='
                  <tr>
                  ...
                  <td align="center" onclick="changeShow(this)">'.$openstatus.'<input type="hidden" name="isdisplay[]" value='.$row['isdisplay'].'></td>
                   <td align="center" onclick="changeShow(this)">'.$mobileshow.'<input type="hidden" name="mobileshow[]" value='.$row['mobileshow'].'></td>
      ...
      if(is_array($arr))
      {
          echo json_encode(array('status'=>true,'list'=>$arr));
      }
