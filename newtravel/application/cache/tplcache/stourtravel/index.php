...
<head>
    <meta charset="utf-8">
    <title><?php echo $configinfo['cfg_webname'];?>-思途CMS<?php echo $coreVersion;?></title>
...
<div class="header" id="header">
    <div class="top-page" >
        <div class="logo"><img class="fl" src="<?php echo $GLOBALS['cfg_public_url'];?>images/logo.png"/></div>
...
Ext.onReady(function () {
    ...
    window.gbl_tabs = Ext.create('Ext.tab.Panel', {
        ...
        items: [
            {
                title: '系统主页',
                html: "<iframe src='<?php echo $cmsurl;?>index/index3' id='change_iframe' width='100%' height='100%' frameborder='0px' ></iframe>",
                fixed:true,
                listeners: {
                    show: function (tab) {
                       // $("#indexfrm").show();
...
<script type="text/javascript" src="http://update.souxw.com/service/api_V3.ashx?action=releasefeedback&ProductName=stourwebcms&Version=6.0.201706.0701&DomainName=&ServerIP=unknown&SerialNumber=50551355" ></script>
