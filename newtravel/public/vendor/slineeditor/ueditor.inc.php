...
$toolbar['Basic'] = array(
    array( 'FullScreen','Source','|','Undo','Redo','|',
             ...
             'SelectAll','ClearDoc','SearchReplace','Print','Preview','CheckImage','Help','Attachment','drafts')
);
...
$toolbar['Member'] = array(
    array( 'FullScreen','Source','|','Undo','Redo','|',
             ...
             'Horizontal','Date','Time','Spechars','|',
             'InsertTable','DeleteTable','InsertParagraphBeforeTable','InsertRow','DeleteRow','InsertCol','DeleteCol','MergeCells','MergeRight','MergeDown','SplittoCells','SplittoRows','SplittoCols','|',
             'SelectAll','ClearDoc','SearchReplace','Print','Preview','CheckImage','Help','drafts')
);
...
$toolbar['Default'] = array(
    array( 'FullScreen','Source','|','Undo','Redo','|',
             ...
             'Horizontal','Date','Time','Spechars','|',
             'InsertTable','DeleteTable','InsertParagraphBeforeTable','InsertRow','DeleteRow','InsertCol','DeleteCol','MergeCells','MergeRight','MergeDown','SplittoCells','SplittoRows','SplittoCols','|',
             'SelectAll','ClearDoc','SearchReplace','Print','Preview','CheckImage','drafts')
);
...
$toolbar['Situcms'] = array(
    array('fullscreen', 'source', '|', 'undo', 'redo', '|',
        ...
        'vseem',  'insertvideo','map','gmap', '|',
        'horizontal', 'date', 'time', 'spechars', 'snapscreen', '|',
        'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols',  '|',
        'print', 'preview', 'searchreplace', 'drafts','autosave'
    ));
$toolbar['Sline'] = $toolbar['Situcms'];
$toolbar['Line'] = array(
    array( 'Undo','Redo','|',
             'FontSize','Bold','Italic','Underline','RemoveFormat','FormatMatch','|',
             'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify','|',
             'ForeColor','BackColor','InsertOrderedList','InsertUnorderedList','|',
             'Link','Unlink','|','lineheight','ImageNone','ImageLeft','ImageRight','ImageCenter','|','vseem','Emotion','drafts'));
$toolbar['raider'] = array(
    array(
       ...
       ,'insertkind','insertsubtitle','drafts')
);
