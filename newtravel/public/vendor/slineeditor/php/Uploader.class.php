...
//        "POST" => "文件大小超出 post_max_size 限制" ,
    ...
    private function upFile( $base64 )
    {
        ...
        if ( $this->stateInfo == $this->stateMap[ 0 ] ) {
            if ( $bool=!move_uploaded_file( $file[ "tmp_name" ] , $this->fullName ) ) {
            ...
            else
            {
                ...
                if(file_exists($waterfile))
                {
                    ...
                    if(in_array($this->fileType,array('.jpg','.jpeg','.gif','.png')) && $water['watermark']['photo_markon'] == '1')
                    {
    ...
    function setWater($imgSrc,$markImg,$markText,$TextColor,$markPos,$fontSize,$markType,$markDiaphaneity)
    {
        ...
        {
            $markImg = '../../../stourtravel/inc/mark/'.$markImg;
        ...
        if(!strcmp($markType,"text"))
        {
            ...
            $fontType="../../../stourtravel/inc/mark/STXINWEI.TTF";
