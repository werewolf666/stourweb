...
*/
 ...
 $.fn.st_readyvalidate=function(config){ 
  ...
  $.st_hintvalidate=function(msg,x,y,seconds){
		         var hint=$("<div class='validate-hint' style='line-height:25px;border:1px solid red;background:white;color:red;padding:1px 4px;position:absolute;top:"+y+"px;left:"+x+"px'>"+msg+"</div>");
