...
{include "pub/search_header"}
    ...
    <div class="big">
        <div class="wm-1200">
            ...
            <div class="search-type-block">
                ...
                <div class="search-type-item clearfix">
                <strong class="item-hd">圈子：</strong>
                 <div class="item-bd">
                    <div class="item-child">
                        <div class="child-block">
                            <ul class="child-list">
                                {st:outdoor action="group" flag="order" row="100"  return="grouplist"}
                                {loop $grouplist $group}
                                <li class="item" ><a  class="choose_groupid {if $group['id']==$params['groupid']} active{/if}" data-id="{$group['id']}"   href="javascript:;" >{$group['title']}</a></li>
                                {/loop}
                            </ul>
                            {if count($grouplist)>8}
                            <a class="arrow down" href="javascript:;">展开</a>
                            {/if}
                        </div>
                    </div>
                ...
                <strong class="item-hd">活动状态：</strong>
                 <div class="item-bd">
                    <div class="item-child">
                        <div class="child-block">
                            <ul class="child-list">
                                <li class="item" ><a  class="choose_bookstatus {if $params['bookstatus']==1} active{/if}" data-id="1"   href="javascript:;" >报名中</a></li>
                                <li class="item" ><a  class="choose_bookstatus {if $params['bookstatus']==4} active{/if}" data-id="4"   href="javascript:;" >已结束</a></li>
                            </ul>
                        </div>
                    </div>
                 </div>
    ...
    <script>
        ...
        $(function(){
            ...
            //出发地选择
            $(".choose_groupid").click(function(){
                $(this).parents('.child-list').find('.choose_groupid').removeClass('active')
                $(this).addClass('active');
                go_search();
            });

            //圈子状态
            $(".choose_bookstatus").click(function(){
                $(this).parents('.child-list').find('.choose_bookstatus').removeClass('active')
                $(this).addClass('active');
                go_search();
            });
        ...
        function go_search()
        {
            ...
            $(".choose_bookstatus").each(function () {
                if($(this).hasClass('active'))
                {
                    bookstatus = $(this).attr('data-id');
                }
            });
            ...
            var url = SITEURL+'query/'+pinyin+'-'+destid+'-'+startcityid+'-'+dayid+'-'+priceid+'-'+groupid+'-'+bookstatus+'-'+attrlist+'?keyword='+search_keyword;
