...
{include "pub/search_header"}
    ...
    <div class="big">
        <div class="wm-1200">
            ...
            <div class="search-type-block">
                ...
                <div class="search-type-item clearfix {if count($grouplist)>4} hide{/if}">
                    <strong class="item-hd">团购状态：</strong>
                    <div class="item-bd">
                        <div class="item-child">
                            <div class="child-block">
                                <ul class="child-list">

                                    <li class="item" ><a  class="choose_status {if $params['statusid']==0} active{/if}" data-id="0"   href="javascript:;" >进行中</a></li>
                                    <li class="item" ><a  class="choose_status {if $params['statusid']==1} active{/if}" data-id="1"   href="javascript:;" >未开始</a></li>
    ...
    <script>
        ...
        $(function(){
            ...
            //选择状态
            $('.choose_status').click(function () {
                $(this).parents('.child-list').find('.choose_status').removeClass('active')
                $(this).addClass('active');
                go_search();
            });
        ...
        function go_search()
        {
            ...
            var url = SITEURL+'query/'+pinyin+'-'+destid+'-'+statusid+'-'+attrlist+'?keyword='+search_keyword;
