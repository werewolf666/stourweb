    ...
    <div class="big">
        <div class="wm-1200">
            ...
            <div class="search-type-block">
                        ...
                        <div class="item-child">
                            <div class="child-block">
                                <ul class="child-list">
                                    ...
                                    {loop $data $r}
                                    <li class="item" ><a  class="choose_days {if $r['id']==$params['dayid']} active{/if}" data-id="{$r['id']}"   href="javascript:;" >{$r['title']}</a></li>
                                    {/loop}
                                </ul>
                                {if count($day_list)>8}
                                <a class="arrow down" href="javascript:;">展开</a>
                ...
                <div class="search-type-item clearfix {if count($grouplist)>2} hide{/if}">
