    ...
    <script>
        ...
        $(function(){
            ...
            $('.choose_model').each(function (index,obj) {
                ...
                if($(obj).attr('data-pinyin').indexOf(pinyin)>-1)
                {
            ...
            $('.st-search-btn').click(function () {
                ...
                if(keyword)
                {
                    var url = SITEURL + 'query/general/index/'+pinyin+'?keyword='+keyword;
                    location.href=url;
                }
            });
            go_search();
        ...
        function go_search()
        {
            ...
            if(keyword)
            {
                var url = SITEURL + 'query/general/get_more/'+pinyin+'?keyword='+keyword+'&page='+page;
            }
            else
            {
                return false;
