    ...
    <script type="text/html" id="tpl_item">
        ...
        <li>
            <a href="{{value.url}}" class="item">
                ...
                <div class="info">
                    <h4 class="alone-tit">{{value.title}}</h4>
                    <div class="txt">
                        {{value.content}}
                    </div>
                    <div class="art-data clearfix">
                        <span class="fl date">{{value.addtime}}</span>
                        <span class="fr num"><i class="pl-icon"></i>{{value.commentnum}}</span>
                        <span class="fr num"><i class="yl-icon"></i>{{value.shownum}}</span>
                    </div>
                </div>
            </a>
        </li>
