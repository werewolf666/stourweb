...
class   Controller_Pc_Global_Line extends Stourweb_Controller
{
    private $_webid = 0;
    function before()
    {
        Model_Global_Search::check_app_install(1);
        //global $sys_webid;
    ...
    public function action_index()
    {
        ...
        $search_items = Model_Global_Module_Line::get_search_items($route_array);
