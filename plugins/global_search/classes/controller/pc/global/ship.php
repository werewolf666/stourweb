...
class   Controller_Pc_Global_Ship extends Stourweb_Controller
{
    private $_webid = 0;
    function before()
    {
        Model_Global_Search::check_app_install(104);
      //  global $sys_webid;
    ...
    public function action_index()
    {
        ...
        $search_items = Model_Global_Module_Ship_Line::get_search_items($route_array);
