...
class   Controller_Pc_Global_Car extends Stourweb_Controller
{
    private $_webid = 0;
    function before()
    {
        Model_Global_Search::check_app_install(3);
     //   global $sys_webid;
    ...
    public function action_index()
    {
        ...
        $carkind = Common::remove_xss($this->request->param('carkind')) ;//租车等级
        ...
        $search_items = Model_Global_Module_car::get_search_items($route_array);
