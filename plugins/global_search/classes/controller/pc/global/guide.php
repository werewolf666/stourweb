...
class   Controller_Pc_Global_Guide extends Stourweb_Controller
{
    private $_webid = 0;
    function before()
    {
    ...
    public function action_index()
    {
        ...
        $route_array = array(
            ...
            'destid' => $destid,
            'typeid' => $typeid,
            'priceid' => is_null($priceid) ? 0 : intval($priceid),
        );

        $search_items = Model_Global_Module_Guide::get_search_items($route_array);
