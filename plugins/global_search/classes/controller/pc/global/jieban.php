...
class   Controller_Pc_Global_Jieban extends Stourweb_Controller
{
    private $_webid = 0;
    function before()
    {
        Model_Global_Search::check_app_install(11);
       // global $sys_webid;
    ...
    public function action_index()
    {
        ...
        $timeid = Common::remove_xss($this->request->param('timeid')) ;//行程日期
        ...
        $search_items = Model_Global_Module_Jieban::get_search_items($route_array);
