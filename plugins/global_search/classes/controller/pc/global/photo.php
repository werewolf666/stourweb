...
class   Controller_Pc_Global_Photo extends Stourweb_Controller
{
    private $_webid = 0;
    function before()
    {
        Model_Global_Search::check_app_install(6);
      //  global $sys_webid;
    ...
    public function action_index()
    {
        ...
        $search_items = Model_Global_Module_Photo::get_search_items($route_array);
