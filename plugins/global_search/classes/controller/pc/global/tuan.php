...
class   Controller_Pc_Global_Tuan extends Stourweb_Controller
{
    private $_webid = 0;
    function before()
    {
        Model_Global_Search::check_app_install(13);
       // global $sys_webid;
    ...
    public function action_index()
    {
        ...
        $statusid = Common::remove_xss($this->request->param('statusid')) ;//状态
        ...
        $search_items = Model_Global_Module_Tuan::get_search_items($route_array);
