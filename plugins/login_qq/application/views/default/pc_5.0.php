...
<style>
    .login-tips{ padding-bottom: 50px;}
    .login-tips .login-bind-tit{ height: auto; padding-bottom:10px; }
    .login-tips .tips{ font-size: 12px; line-height: 13px;}
    .login-tips .tips em{ color: #f00; padding: 0 5px;}
</style>
<script>
    ...
    $(document).ready(function () {
        ...
        function user_bind(data) {
            $.post('/plugins/login_qq/index/bind', data, function (rs) {
                if (rs.bool == true) {
...
<div class="st-userlogin-box">
    <div class="st-login-wp">
        <div class="login-bind-box login-tips">
            <div class="login-bind-tit">绑定账号<p class="tips">你已登录<em><?php echo $user['nickname'];?></em>账号，请选择绑定站点账号或直接登录</p></div>
