...
class Kohana_ORM extends Model implements serializable {
     ...
     * actual model
     * */
    protected $_actual_model_name = NULL;

    /*
     * usercolumns
     * */
    protected $_usercolumns = NULL;
    ...
    /*
     * Return an array of columns I want.
     * */
    public function select_column($column_arr)
    {
        $columns = array();
	...
	protected function _load_result($multiple = FALSE)
	{
		...
		if ($multiple === TRUE)
		{
            ...
            $objname = isset($this->_actual_model_name) ? $this->_actual_model_name : get_class($this);
			$result = $this->_db_builder->as_object($objname)->execute($this->_db);
