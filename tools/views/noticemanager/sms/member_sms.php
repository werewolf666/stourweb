...
<body>
<table class="content-tab" bottom_top=jtHwOs >
    <tr>
        ...
        <td valign="top" class="content-rt-td">
            ...
            <form id="msgfrm">
                <ul class="info-item-block clearfix">
                    ...
                    <li>
                        <span class="item-hd mt-10 w120">
                            <div class="box-tit">{$msg_member_action}{Common::get_help_icon('noticemanager_member_sms_'.$msg_config_value['msgtype'])}：</div>
                        </span>
                        <div class="item-bd pl-120">
                            ...
                            <div class="set-one w900">
                                <div class="box-con text-l bk-gray">
