{st:spot action="query" flag="theme" themeid="$info['id']" row="6"}
{if !empty($data)}
<div class="theme-container">
    <h3 class="theme-tit"><i class="spot-icon"></i>推荐景点</h3>
    <div class="theme-wrap">
        ...
        <div class="more-item"><a class="more-link" href="{$cmsurl}spots/all">查看更多</a></div>
    </div>
</div>
{/if}