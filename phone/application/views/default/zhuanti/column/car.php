{st:car action="query" flag="theme" themeid="$info['id']"  row="6"}
{if !empty($data)}
<div class="theme-container">
    <h3 class="theme-tit"><i class="car-icon"></i>推荐租车</h3>
    <div class="theme-wrap">
        ...
        <div class="more-item"><a class="more-link" href="{$cmsurl}cars/all">查看更多</a></div>
    </div>
</div>
{/if}